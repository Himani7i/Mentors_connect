...
const socket = io("https://mentors-connect.onrender.com");
  ...
  useEffect(() => {
    const check_cookie = async () => {
      const response = await axios.post(
        "https://mentors-connect.onrender.com/check-cookie",
        {},
        {
    ...
    const fetchmessage = async () => {
      const response = await axios.get("https://mentors-connect.onrender.com/get-messages", {
        withCredentials: true,
      });
  ...
  useEffect(() => {
    const response = async () => {
      const userinfo = await axios.post(
        "https://mentors-connect.onrender.com/info-for-message",
        {},
        {
          withCredentials: true,
        }
